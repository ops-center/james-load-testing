...
func (a *AddressGroupAPIService) AddMemberExecute(r ApiAddMemberRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/address/groups/"+r.groupAddress+"/"+*r.memberAddress
	...
	//localVarPath = strings.Replace(localVarPath, "{"+"memberAddress"+"}", url.PathEscape(parameterValueToString(r.memberAddress, "memberAddress")), 1)
